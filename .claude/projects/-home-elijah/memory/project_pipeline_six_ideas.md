...
metadata: 
  node_type: memory
  type: project
  originSessionId: d483412a-4d03-44fd-9576-f3337d5eb878
---

Six projects captured in one voice session 2026-05-23 while IPTV was live. Full details in `~/MD/project_pipeline.md`.

1. **Fair Chance Employer** (Dezzy Zero) — automated job application machine, 200 apps/30 days, already in motion. [[project_closed_loop_agent_framework]]
...
**How to apply:** Start sessions by asking "which project are we working on today" — never let the queue go cold across all six.
