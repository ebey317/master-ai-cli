...
### Sensei terminal agent
![Sensei TUI demo](media/demo/gifs/clip_01_000000_00.gif)

*Terminal agent with streaming responses, slash commands, and model routing display.*

### Pupil browser extension
![Pupil browser demo](media/demo/gifs/clip_02_000014_33.gif)

*Chrome extension side panel — same brain as Sensei, visual interface for web work.*

### Voice I/O pipeline
![Voice demo](media/demo/gifs/clip_03_000023_35.gif)

*Push-to-talk STT → agent reasoning → TTS response (Aria Neural voice).*

### Subagent delegation
![Subagent demo](media/demo/gifs/clip_04_000515_57.gif)

*Spawns specialized workers: code review, file discovery, test execution, context inspection.*

### Memory system
![Memory demo](media/demo/gifs/clip_05_000556_98.gif)

*Persistent cross-session memory for projects, preferences, and user context.*

### Model routing + fallback
![Routing demo](media/demo/gifs/clip_06_001109_52.gif)

*Auto-selects local Ollama or cloud providers, falls back across tiers on errors.*

---

## Screenshots

![Sensei terminal session](media/demo/snapshots/snapshot_01_000000_00.png)
*Sensei TUI with streaming tokens, model badge, and approval queue.*

![Pupil side panel](media/demo/snapshots/snapshot_02_000014_33.png)
*Pupil browser extension analyzing a webpage with CDP integration.*

![Voice bridge dashboard](media/demo/snapshots/snapshot_03_000023_35.png)
*STT/TTS server health, active sessions, audio device status.*

![Subagent registry](media/demo/snapshots/snapshot_04_000515_57.png)
*Available subagents: code_reviewer, context_inspector, directive_simulator, file_finder, spend_reporter, test_runner.*

![Memory viewer](media/demo/snapshots/snapshot_05_000556_98.png)
*Cross-session memory: project context, user preferences, conversation history.*

![Full system architecture](media/demo/snapshots/snapshot_06_001109_52.png)
*Complete stack: Sensei, Pupil, model router, MCP tools, subagents, memory, safety layer.*
