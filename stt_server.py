...
def _api_prompt(prompt, *, source="", page_context=None, schedule_id="",
    ...
    lines.extend([
        ...
        "Small talk / greetings / casual chat — when the user's message is only a greeting or social remark with no browser task, reply conversationally and emit ZERO browser actions. Do not read the current page unless the user explicitly asks for page content.",
